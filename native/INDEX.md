...
| FRONT DOOR | The six layers — ontology · workflow design · agents · feedback · marketplaces · tooling (the generating rule, founder 2026-09-08) | [`the-six-layers.html`](./the-six-layers.html) |
| FRONT DOOR | The factory — what we build, and how: six questions · stage ladder · eight features with build options · the dials (every axis read in the factory) | [`factory.html`](./factory.html) |
| FRONT DOOR | Structure and terms — how Sutra is organized (Domain > Charter + Placements + Artifacts; Module, Component, doc layer; the rule for anything new) | [`structure-and-terms.html`](./structure-and-terms.html) |
...
| PLATFORM | VSM: the five units — research behind the five functions (Beer's Viable System Model mapped to identity · adaptation · priority · coordination · audit) | [`platform/model/research/vsm-five-units.html`](./platform/model/research/vsm-five-units.html) |
